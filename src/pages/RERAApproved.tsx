        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center text-white max-w-4xl mx-auto">
            ...
            <p className="text-xl text-green-100">
              Officially Approved with Complete Legal Transparency
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">
              Government ensures your investment is safe and legally compliant
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Complete legal protection for your investment
              </p>
            </div>
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                All documents are verified and transparent
              </p>
            </div>
            <div className="text-center p-6">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Ensures project quality and delivery
              </p>
            </div>
          </div>
        </div>
