        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              ...
              className="bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white font-semibold px-8 py-4 text-lg rounded-lg shadow-2xl transition-all duration-300 hover:shadow-yellow-500/25 hover:scale-105"
            >
              Get Brochure
            ...
            <Button 
              onClick={() => scrollToSection('contact')}
              variant="outline" 
              className="border-2 border-white text-white hover:bg-white hover:text-blue-900 font-semibold px-8 py-4 text-lg rounded-lg backdrop-blur-sm transition-all duration-300 hover:scale-105"
            >
              Book Site Visit
            </Button>
          </div>
